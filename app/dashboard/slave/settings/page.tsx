            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  defaultValue="Experienced trader with a focus on forex markets. I've been trading for over 5 years and joined Traders Circle to learn from the best."
                />
              </div>
              <div className="space-y-2">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4 pt-6 border-t">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="master-updates">Master Account Updates</Label>
                      <p className="text-sm text-muted-foreground">Receive emails about master account changes</p>
                    </div>
                    <Switch id="master-updates" defaultChecked />
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="billing-updates">Billing Updates</Label>
                      <p className="text-sm text-muted-foreground">Receive emails about billing and subscriptions</p>
                    </div>
              ...
              <div className="space-y-4 pt-6 border-t">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="address-line1" defaultValue="123 Trading St" />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="rounded-md border">
                  <div className="flex items-center justify-between p-4 border-b">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">3 subscriptions</p>
                    </div>
